...
var Animals=new Array("Chuột","Trâu","Cọp","Mèo","Rồng","Rắn","Ngựa","Dê","Khỉ","Gà","Chó","Heo");
var Gan=new Array("Giáp","Ất","Bính","Đinh","Mậu","Kỷ","Canh","Tân","Nhâm","Quý");
var Zhi=new Array(" Tí "," Sửu "," Dần "," Mẹo "," Thìn "," Tị "," Ngọ "," Mùi "," Thân "," Dậu "," Tuất "," Hợi ");
var now;
var SY;
var SM;
var SD;
...
//	document.getElementById("date").innerText = weekday()+" Ngày "+SD+" Tháng "+(SM+1)+" Năm "+ SY;
...

{
    ...
    var tt =' Âm lịch ngày ' + lDObj[0] + ' Tháng ' + lDObj[1] + ' Năm ' + cyclical(lDObj[2]-1900+36);
