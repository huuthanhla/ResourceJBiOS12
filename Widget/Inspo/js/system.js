...
var systemdivs = function () { //system
    'use strict';
    var sysArray = ['batteryperslashcharge', 'alarmstringsmall', 'alarmstring', 'alarmsday', 'alarmday', 'alarmhr', 'alarmmin' ,'name', 'firmware', 'battery', 'batterypercent', 'chargingtxt', 'chargingstate', 'unlock', 'signal', 'signalpercent', 'alarm24', 'alarm', 'alarmpm', 'wifi', 'wifipercent', 'notifymail', 'notifysms', 'notifyphone', 'notifywhats', 'notifytelegram', 'ramUsed', 'ramFree', 'ramAvailable', 'ramUsedMB', 'ramFreeMB', 'ramAvailableMB', 'notifyfbmessenger', 'notifydiscord', 'notifyviber', 'notifyinstagram', 'notifyfacebook', 'notifygmail', 'notifyoutlook', 'notifyairmail', 'notifyymail', 'notifysnapchat', 'notifyreddit', 'notifygoogleplus', 'notifylinkedin', 'notifyslack', 'notifytelegramx', 'notifyspark', 'flashlight', 'searchicon', 'searchtext' ],
